...
def nouveau_salon():										  # La fonction commence par récupérer le nom du salon soumis par l'utilisateur via le formulaire
    ...
    Liste_salons = pd.concat([Liste_salons,nouveau_salon], ignore_index=True)               # ce code permet d'ajouter un nouveau salon à une liste de salons stockée dans un fichier CSV, 
